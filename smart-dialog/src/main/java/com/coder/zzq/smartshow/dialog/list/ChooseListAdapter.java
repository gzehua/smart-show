...
public class ChooseListAdapter extends BaseAdapter {
    ...
    private int mCheckMarkPos = ChooseListDialogProvider.CHECK_MARK_POS_LEFT;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mCheckMarkPos == ChooseListDialogProvider.CHECK_MARK_POS_LEFT) {
